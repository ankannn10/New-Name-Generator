...
print(2)
'''def generate_nickname(model, num_samples):
    ...
    for _ in range(num_samples):
        ...
        while True:
            ...
            probs = F.softmax(logits, dim = 1)  # Change dim to -1 for correct softmax
            # Sample from the distribution
            ix = torch.multinomial(probs, num_samples=1).item()  # Sample from last output
        ...
        nickname = ''.join(itos[i] for i in out)
